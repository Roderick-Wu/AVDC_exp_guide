...
class MyPolicy_CL(Policy):
    ...
    def calculate_next_plan(self):
        ...
        core = self.video_model.model.probe.probe_dir ##
        self.video_model.model.probe.probe_dir = f"{self.video_model.model.probe.probe_dir}/video_{self.replans}" ##
        #self.video_model.model.fail_classifier = self.video_model.fail_classifier ##
        images = pred_video(self.video_model, image, self.task)
        self.video_model.model.probe.probe_dir = core ##
