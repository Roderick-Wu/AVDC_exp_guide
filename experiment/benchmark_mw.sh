...
for gw in 0 2 4 8 16 32 64 128 256 512
do 
    CUDA_VISIBLE_DEVICES=$1 accelerate launch benchmark_mw.py --env_name $task --n_exps 25 --ckpt_dir "../ckpts/metaworld" --milestone 24 --result_root "../results/results_AVDC_mw" --gw $gw
done
